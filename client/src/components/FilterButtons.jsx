  ...
  return (
    <div className='border border-gray-300 rounded-md px-4 py-1 relative cursor-pointer hover:border-gray-400'>
        ...
        {filterData&& filterMenu && (
            ...
            exit={{opacity:0,y:50}}
        className='w-48 z-50 backdrop-blur-sm max-h-44 overflow-x-scroll scrollbar-thin
        scrollbar-track-gray-200 scrollbar-thumb-gray-400 flex flex-col rounded-md shadow-md absolute top-8 left-0'>
            {filterData?.map((data)=>(
